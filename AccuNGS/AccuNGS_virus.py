...
def main():
    ...
    ref_atcg1 = "/sternadi/home/volume3/okushnir/ref/human/NM_001614.5_ACTG1_56-1914.fa"
    ref_flna1 = "/sternadi/home/volume3/okushnir/ref/human/FLNA_5185-7688.fasta"
    ref_opv_33 = ""

    folders = glob.glob(input_dir_FLNA + "/*")
    # print(folders)
    ...
    for d in folders:
        ...
        cmd = "python /sternadi/home/volume1/shared/SternLab/pipeline_runner.py -i %s -o %s -r %s -NGS_or_Cirseq 2 -rep 2  -q 30" % (d, output_dir, ref_flna1)
