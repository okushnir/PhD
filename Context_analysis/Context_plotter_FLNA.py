...
# Transitions mutations plot
    ...
    transiotion_plot.set_title("Transitions variant frequency in FLNA")
    transiotion_plot.legend(loc="upper right")

    plt.savefig(output_dir + "Transitions_variant_frequency_in_FLNA.png", dpi=300)
    plt.close()
...
# facet plot for all mutations
    ...
    cat_plot.fig.suptitle("Transitions variant frequency in FLNA", y=0.99)
    # cat_plot.legend(loc="upper right")

    plt.savefig(output_dir + "Facet_Transitions_variant_frequency_in_FLNA.png", dpi=300)
    plt.close()
...
# Just silent mutations
    ...
    silent_plot.set_title("Transitions variant frequency in FLNA, only silent mutations")
    silent_plot.legend(loc="upper right")
    plt.tight_layout()
    plt.savefig(output_dir + "Silent_Transition_variant_frequency_in_FLNA.png", dpi=300)
    plt.close()
...
# 5’ neighbors preferences
    ...
    context_plot.set_title("FLNA in cell culture 5’ neighbors preferences")
...
# anti-sense neighbors preferences
    ...
    context_UC_plot.set_title("FLNA in cell culture anti-sense neighbors preferences")
