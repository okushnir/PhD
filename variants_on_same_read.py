#! /powerapps/share/python-anaconda-3.5.0.0/bin/python3.6
...
def main(args):
    ...
    variants_combinations = range(input_x + 1, input_x + 300)
    ...
    for y in variants_combinations:
        ...
        if ct.shape == (2, 2):
            ...
            print('\t'.join([str(x) for x in [x, y, fisher_test[0], fisher_test[1],
                                              ct[1][1] * 1.0 / (ct[0][0] + ct[0][1] + ct[1][0] + ct[1][1])]]))
        else:
