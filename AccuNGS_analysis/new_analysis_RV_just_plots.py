...
def main():
    ...
    g11 = sns.lmplot(x="passage", y="Frequency", data=data_filter_ag_grouped, hue="ADAR_like", markers=["o", "x"],
                     hue_order=[True, False], fit_reg=True, col="Type", col_order=type_order_ag, palette=flatui)
    g11.set(xlim=(0, 13))
    # g11.set(yscale="log")
    ...
    position_g = sns.scatterplot("Pos", "Frequency", data=data_filter_ag, hue="Gene",
    ...
    data_filter_ag = data_filter_ag[data_filter_ag["Gene"] != "2A"]
    data_filter_ag = data_filter_ag[data_filter_ag["Gene"] != "3'UTR"]
    data_filter_ag = data_filter_ag[data_filter_ag["Type"] == "Synonymous"]

    position_mutation = sns.relplot(x="Pos", y="Frequency", data=data_filter_ag, hue="Gene", col="passage",
