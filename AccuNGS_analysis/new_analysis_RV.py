...
def main():
    ...
    passage_g = sns.catplot(x="passage", y="frac_and_weight", data=data_filter, hue="Mutation", order=miseq_order, palette="tab20"
                        ,kind="point", dodge=True, hue_order=transition_order, join=False, estimator=weighted_varaint,
                     orient="v", legend=True)
    ...
    g7 = sns.relplot(x="passage", y="frac_and_weight", hue="Context", data=data_filter_ag, palette="Paired", kind="line",
    ...
    mutation_g8 = sns.relplot(x="passage", y="frac_and_weight", hue="ADAR_like", data=data_filter_ag, palette=flatui,
                     kind="line", col="Type", col_order=type_order, estimator=weighted_varaint)#, hue_order=context_order)
    ...
    data_filter_ag_grouped = data_filter_ag.groupby(["ADAR_like", "label", "Type", "Pos", "Protein", "passage"])["frac_and_weight"].agg(lambda x: weighted_varaint(x))
    ...
    stat_slope1, stat_intercept1, r_value1, p_value1, std_err1 = stats.linregress(data_reg_adar_syn['passage'],
                                                                        data_reg_adar_syn['Frequency']) #passage
...
<<<<<<< HEAD
    ...
    plt.close()
=======
>>>>>>> 42cde9c0830409e034e8f1bcb5e56a18d92d2fef
