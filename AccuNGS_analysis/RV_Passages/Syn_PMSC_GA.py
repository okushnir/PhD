...
def main():
    ...
    # plt.show()
    plt.savefig("D:/My Drive/Studies/PhD/Projects/RV/RVB14/p12_1/transition_freq_Accu.png", dpi=300)
    plt.close()
    ...
    plt.axhline(y=5*10**-4, color='r', linestyle='--')
    plt.savefig("D:/My Drive/Studies/PhD/Projects/RV/RVB14/p12_1/transition_freq_Accu_boxplot.png", dpi=300)
    plt.close()
    ...
    fig3 = sns.boxplot(y="Frequency", x="passage", data=table_ga, hue="Type",
    ...
    annot = Annotator(fig3, pairs, x="passage", y="Frequency", hue="Type", data=table_ga,
                      hue_order=["Synonymous", "Premature Stop Codon"])#order=range(0, 13, 1),
    annot.configure(test='Mann-Whitney', text_format='star', loc='outside', verbose=2, comparisons_correction="Bonferroni")
    annot.apply_test()
    file_path = "D:/My Drive/Studies/PhD/Projects/RV/RVB14/p12_1/sts.csv"
    ...
    plt.axhline(y=5*10**-4, color='r', linestyle='--')
    plt.tight_layout()
    plt.savefig("D:/My Drive/Studies/PhD/Projects/RV/RVB14/p12_1/GA_freq_Accu_boxplot.png", dpi=300)
    plt.close()
