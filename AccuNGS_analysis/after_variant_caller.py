...
def main():
    virus = "RVB14"
    input_dir = "/Users/odedkushnir/Projects/fitness/AccuNGS/190627_RV_CV/%s/new" % virus
    dirs = glob.glob(input_dir + "/%s_p*" % virus)
    for passage in dirs:
        input_path = glob.glob(passage + "/q38_3UTR")
        # "/Users/odedkushnir/Projects/fitness/AccuNGS/190627_RV_CV/RVB14/RVB14_p5_L001-ds.b723553755a44959a7dc6debdb4558ea/q38_3UTR"
        sample = passage.split("/")[-1].split("_p")[0] + "-p" + passage.split("_p")[1].split("_")[0]
        out_file = passage + "/q38_3UTR/" + sample + ".merged.freqs"
        # print(type(sample))
