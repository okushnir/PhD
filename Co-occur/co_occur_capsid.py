...
#     """1. Create all_parts.blast, all_parts.blast.cropped, mutations_all.txt.cropped"""
    # cmds = "for sample in Capsid_31_Amicon Capsid_32_Ultra Capsid_33_Ultra Free_31_Amicon Free_32_Ultra Free_33_Amicon " \
    #        "Free_33_Ultra; do cd /sternadi/home/volume3/okushnir/AccuNGS/20201008RV-202329127/merged/capsid/${sample}" \
    #        "/20201012_q38; cat mutations_all.txt | grep -v ref_pos > mutations_all.txt.cropped ; for file in " \
    #        "`ls tmp/*.blast`; do cat $file >> all_parts.blast ; done ; cat all_parts.blast | cut -f1,2,3 > " \
    #        "all_parts.blast.cropped ; done"
