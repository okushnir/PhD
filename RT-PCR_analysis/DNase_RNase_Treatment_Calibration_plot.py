...
def plot_generation_time(file_name1):#1, file_name2):
    ...
    plt.savefig("/Users/odedkushnir/Google Drive/Studies/PhD/Prgress reports/20200913 Final report/plots" + "/RNase_DNase_Calibration.png", dpi=300)
    return data
...
def main():
    ...
    # file_name1 = "/Users/odedkushnir/Google Drive/Studies/PhD/Projects/RV/RVB14/RealTime Results xlsx/20191107 capsid/Oded_2019-11-07 12-39-22_BR003827 -  Quantification Cq Results_0.csv"
    file_name2 = "/Users/odedkushnir/Google Drive/Studies/PhD/Projects/RV/RVB14/RealTime Results xlsx/20191205 capsid/" \
                 "Oded_2019-12-05 10-35-18_BR003827 -  Quantification Cq Results_0.csv"
