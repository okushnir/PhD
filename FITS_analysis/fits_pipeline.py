...
if __name__ == "__main__":
    ...
    parser.add_argument("mutation_all_at_once", type=str, help="on/off for execute the mutation mode all at once or NOT"
                                                               "\nTo deduce Mutation - needs to be on\n "
                                                               "To deduce Fitness needs to be off ")
