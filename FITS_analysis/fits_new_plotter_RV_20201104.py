...
def main():
    ...
    # rv_replica1_mutation_data = post_data_mutation("Z:/volume3/okushnir/AccuNGS/"
    ...
    # rv_replica2_mutation_data = post_data_mutation("Z:/volume3/okushnir/AccuNGS/"
    #                                                "20201008RV-202329127/merged/passages/fits_all_pos_at_once_sampling/"
    #                                                "replica2_syn/output/mutation/%s" % passages)
    # rv_replica2_mutation_data["Virus"] = "RVB14 #2"
    # rv_replica3_mutation_data = post_data_mutation("Z:/volume3/okushnir/AccuNGS/"
    #                                                "20201008RV-202329127/merged/passages/fits_all_pos_at_once_sampling/"
    #                                                "replica3_syn/output/mutation/%s" % passages)
    # rv_replica3_mutation_data["Virus"] = "RVB14 #3"
    # cv_mutation_data = post_data_mutation("Z:/volume3/okushnir/AccuNGS/190627_RV_CV"
    #                                                   "/merged/CVB3/Rank0_data_mutation/fits/output/mutation/%s" % passages)
    # cv_mutation_data["Virus"] = "CVB3"
    # opv_mutataion_data = post_data_mutation("Z:/volume3/okushnir/CirSeq/OPV/fits/output/mutation/"
    #                                         "all_positions_p1-p7")
    # opv_mutataion_data["Virus"] = "OPV2"
    #
    # pv_mutataion_data = post_data_mutation("Z:/volume3/okushnir/CirSeq/Mahoney/fits/output/"
    #                                        "mutation/p3-p8")
    # pv_mutataion_data["Virus"] = "PV1"
    #
    #
    #
    # output_dir = "Z:/volume3/okushnir/AccuNGS/20201008RV-202329127/merged/passages/" \
    ...
    pairs = [(("RVB14 #1", "A>G"), ("RVB14 #1", "U>C")), (("RVB14 #1", "A>G"), ("RVB14 #1", "C>U")),
             (("RVB14 #1", "A>G"), ("RVB14 #1", "G>A")),
             (("RVB14 #1", "U>C"), ("RVB14 #1", "C>U")), (("RVB14 #1", "U>C"), ("RVB14 #1", "G>A")),
             (("RVB14 #2", "A>G"), ("RVB14 #2", "U>C")), (("RVB14 #2", "A>G"), ("RVB14 #2", "C>U")),
             (("RVB14 #2", "A>G"), ("RVB14 #2", "G>A")),
             (("RVB14 #2", "U>C"), ("RVB14 #2", "C>U")), (("RVB14 #2", "U>C"), ("RVB14 #2", "G>A")),
             (("RVB14 #3", "A>G"), ("RVB14 #3", "U>C")), (("RVB14 #3", "A>G"), ("RVB14 #3", "C>U")),
             (("RVB14 #3", "A>G"), ("RVB14 #3", "G>A")),
             ...
             (("PV1", "A>G"), ("PV1", "U>C")), (("PV1", "A>G"), ("PV1", "G>A")), (("PV1", "U>C"), ("PV1", "G>A"))]
